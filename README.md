...
<div align="center">
    ...
    <a href="https://gitee.com/ukoko/ya-layui-admin"><img alt="abc" src="https://img.shields.io/badge/Ya Admin-v1.4-blue"></a>
...
```angular17html
此模板不支持响应式布局,对于后台管理系统来说移动端响应式意义不大,如果经常使用手机端浏览器登陆后管,建议开发APP.
...
├── img/                # 项目图片资源
├── js/                 # JavaScript 脚本
├────── echarts6.0.0.js # Apache echart图表
├────── index.js        # Ya-Admin核心JS文件
