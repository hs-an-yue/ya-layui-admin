...
此模板是一款基于前端UI框架 [Layui](https://layui.dev) 生成的后台管理模板，此模板根据当前最新版本(2025-11-25)的Layui框架实现。主要针对喜欢Layui的后端开发者和前端开发者以及针对只掌握少量前端知识(HTML/CSS/JS)但是想快速构建后台管理系统的后端开发人员。

### 项目结构展示

<img src="https://share.note.youdao.com/yws/api/personal/file/WEBdad76b50dbf3457bea421218b866cc8e?method=download&shareKey=f13a1a3f464a0f750f4cf8f12a8c0068" alt="abc">

> QQ群

<a href="https://gitee.com/ukoko/ya-layui-admin"><img alt="abc" src="https://img.shields.io/badge/QQ-948233848-blue"></a>